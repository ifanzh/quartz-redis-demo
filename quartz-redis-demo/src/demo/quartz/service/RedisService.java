...
public class RedisService {
	...
	static {
		...
		pool = new JedisPool(
				conf,
				PropertyUtil.readValueByRedis(Constant.REDIS_HOST),
				Integer.parseInt(PropertyUtil.readValueByRedis(Constant.REDIS_PORT)),
				Integer.parseInt(PropertyUtil.readValueByRedis(Constant.REDIS_TIMEOUT)),
				PropertyUtil.readValueByRedis(Constant.REDIS_PASSWORD), Integer
						.parseInt(PropertyUtil
								.readValueByRedis(Constant.REDIS_DATABASE)));
	}
